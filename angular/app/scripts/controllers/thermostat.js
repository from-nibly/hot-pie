    ...
    (function () {
        thermostatService.getCurrentTemp().then(function (body, resp, err) {
            if (err) {
                ...
                var newValue = body.data.newValue;
                thermostatService.getOverrideTemp().then(function (body, resp, err) {
                    $scope.temp = parseInt(body.data.newValue) || newValue;
